...
export const projects: Project[] = [
  {
    id: 'making-code',
    title: 'Making Code',
    description: 'Making Code is the corner where I share my experiences and knowledge about technology, software development, cryptography, blockchain, artificial intelligence, and much more.',
  ...
  },
  {
    ...
    description: 'Three NestJS microservices with PostgreSQL per service and Kafka-compatible event bus (Redpanda). Implements outbox pattern, idempotent consumers, retry/DLQ, and optional LLM integration via Ollama.',
  ...
  },
  {
    ...
    description: 'Production-ready boilerplate with Clean Architecture, CQRS, TypeORM, and PostgreSQL. Supports monolith, multi-tenant, and microservices patterns with comprehensive documentation.',
  ...
  },
  {
    ...
    description: 'Service responsible for notarizing documents using the Algorand blockchain. Built with NestJS and TypeScript for cryptographic document verification and immutable record keeping.',
  ...
  },
  {
    ...
    description: 'Complete framework for AI-assisted Spec-Driven Development. Includes templates, session management, architecture validation scripts, and agent rules for controlled AI code generation.',
  ...
  },
  {
    ...
    description: 'REST API with database-per-tenant isolation using NestJS, MongoDB, and CQRS. Features connection pooling, tenant middleware, and complete data separation between tenants.',
  ...
  },
  {
    ...
    description: 'Implementation of microservices with NestJS and RabbitMQ, utilizing the microservices architecture for user and transaction management.',
  ...
  },
  {
    ...
    description: 'Dedicated users microservice built with NestJS and RabbitMQ for distributed user management, authentication, and event-based communication.',
  ...
  },
  {
    ...
    description: 'API Gateway implementation with NestJS that routes requests to microservices via RabbitMQ message broker, providing a unified entry point for the distributed system.',
